...
Author: Rival Haikal
Date: 26/04/2023
This is the bmi_tuner.py module.
Usage:
- tuner model
"""
...
from bmi_transform import (LABEL_KEY, CATEGORICAL_FEATURES, NUMERICAL_FEATURES,
                           transformed_name)
...
def get_model_tuner(hyperparameters):
    ...
    outputs = layers.Dense(6, activation=tf.nn.softmax)(deep)
